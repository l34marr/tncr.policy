...
#
#  $ bin/test -s tncr.policy -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src tncr.policy.testing.TNCR_POLICY_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/tncr/policy/tests/robot/test_example.robot
#
